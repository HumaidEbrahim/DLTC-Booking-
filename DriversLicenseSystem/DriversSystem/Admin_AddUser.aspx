<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin_AddUser.aspx.cs" Inherits="DriversSystem.Admin_AddUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-container">
     ...
     <asp:TextBox ID="IDNumber" runat="server" CssClass="form-control"  />
        <asp:Label ID="ErrorMessage" runat="server" Text="" CssClass="error-message" Visible="False" ForeColor="Red" />
 </div>
